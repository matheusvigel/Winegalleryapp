...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Wine Gallery',
        short_name: 'Wine Gallery',
        description: 'Descubra, colecione e mergulhe no mundo dos vinhos.',
        theme_color: '#6B0035',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          // Cache Unsplash placeholder images
          {
          ...
          // App shell / API: network-first with offline fallback
          {
